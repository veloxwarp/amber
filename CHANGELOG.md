...
* Allow `encrypt` subcommand to take secret value from `stdin` [#15](https://github.com/veloxwarp/amber/issues/15)
...
* Add masking support [#1](https://github.com/veloxwarp/amber/issues/1)
* Add subcommand `generate` [#7](https://github.com/veloxwarp/amber/pull/7)
...
* Rework print subcommand to provide more output styles.
  [#11](https://github.com/veloxwarp/amber/pull/11)
